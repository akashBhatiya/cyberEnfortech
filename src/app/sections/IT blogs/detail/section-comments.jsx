    ...
    <>
      <div className="clear comment-section-outer" id="comment-list">
        <div className="comments-area" id="comments">
          <h2 className="comments-title m-b30">
                ...
                <div className="comment-body">
                  <div className="comment-author vcard">
                    <ItodoImage
                      ...
                      src="images/blog/blog-comment/av1.jpg"
                      alt=""
                    />
                  ...
                  <li className="comment odd parent">
                    <div className="comment-body">
                      <div className="comment-author vcard">
                        <ItodoImage
                          className="avatar photo"
                          src="images/blog/blog-comment/av2.jpg"
                          alt=""
                        />
            ...
            <div className="comment-respond m-t30" id="respond">
              ...
              <form className="comment-form row" id="commentform" method="post">
                ...
                <p className="form-submit">
                  ...
                  >
                    <i className="fa  fa-long-arrow-right" /> Post Comment{" "}
                  </button>
                </p>
              </form>
            </div>
