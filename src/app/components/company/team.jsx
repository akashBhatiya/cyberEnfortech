                ...
                <div className="our-team-2">
                  ...
                  <div className="figcaption">
                    ...
                    <h4 className="sx-title">
                      <NavLink to="/about-us">Michael Smith</NavLink>
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="our-team-2">
                  ...
                  <div className="figcaption">
                    <p>Managing Director</p>
                    <h4 className="sx-title">
                      <NavLink to="/about-us">Delilah Brooklyn</NavLink>
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="our-team-2">
                  ...
                  <div className="figcaption">
                    <p>Managing Director</p>
                    <h4 className="sx-title">
                      <NavLink to="/about-us">Leilani Kennedy</NavLink>
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="our-team-2">
                  ...
                  <div className="figcaption">
                    <p>Managing Director</p>
                    <h4 className="sx-title">
                      <NavLink to="/about-us">Bella Natalia</NavLink>
                    </h4>
                  </div>
                </div>
              </div>
