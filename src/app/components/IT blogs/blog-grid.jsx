          ...
          <div className="masonry-outer mfp-gallery news-grid clearfix row">
              ...
              <div className="sx-latest-post-st-1">
                <div className="sx-post-media sx-img-effect img-reflection">
                  <NavLink to="/blogs/detail">
                    <ItodoImage src="images/blog/blog-grid/pic1.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="sx-post-info p-t30">
                  ...
                  <div className="sx-post-title ">
                    <h4 className="post-title">
                      <NavLink to="/blogs/detail">
                        Standard size of business agency kal Consulat Latest
                        Management.
                      </NavLink>
                    </h4>
                  </div>
            ...
            <div className="masonry-item  col-lg-4 col-md-6 col-sm-12 m-b30">
              <div className="sx-latest-post-st-1">
                <div className="sx-post-media sx-img-effect img-reflection">
                  <NavLink to="/blogs/detail">
                    <ItodoImage src="images/blog/blog-grid/pic2.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="sx-post-info p-t30">
                  <div className="sx-post-meta ">
            ...
            <div className="masonry-item  col-lg-4 col-md-6 col-sm-12 m-b30">
              <div className="sx-latest-post-st-1">
                <div className="sx-post-media sx-img-effect img-reflection">
                  <NavLink to="/blogs/detail">
                    <ItodoImage src="images/blog/blog-grid/pic3.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="sx-post-info p-t30">
                  <div className="sx-post-meta ">
            ...
            <div className="masonry-item  col-lg-4 col-md-6 col-sm-12 m-b30">
              <div className="sx-latest-post-st-1">
                <div className="sx-post-media sx-img-effect img-reflection">
                  <NavLink to="/blogs/detail">
                    <ItodoImage src="images/blog/blog-grid/pic4.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="sx-post-info p-t30">
                  <div className="sx-post-meta ">
            ...
            <div className="masonry-item  col-lg-4 col-md-6 col-sm-12 m-b30">
              <div className="sx-latest-post-st-1">
                <div className="sx-post-media sx-img-effect img-reflection">
                  <NavLink to="/blogs/detail">
                    <ItodoImage src="images/blog/blog-grid/pic5.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="sx-post-info p-t30">
                  <div className="sx-post-meta ">
            ...
            <div className="masonry-item  col-lg-4 col-md-6 col-sm-12 m-b30">
              <div className="sx-latest-post-st-1">
                <div className="sx-post-media sx-img-effect img-reflection">
                  <NavLink to="/blogs/detail">
                    <ItodoImage src="images/blog/blog-grid/pic6.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="sx-post-info p-t30">
                  <div className="sx-post-meta ">
            ...
            <div className="masonry-item  col-lg-4 col-md-6 col-sm-12 m-b30">
              <div className="sx-latest-post-st-1">
                <div className="sx-post-media sx-img-effect img-reflection">
                  <NavLink to="/blogs/detail">
                    <ItodoImage src="images/blog/blog-grid/pic7.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="sx-post-info p-t30">
                  <div className="sx-post-meta ">
            ...
            <div className="masonry-item  col-lg-4 col-md-6 col-sm-12 m-b30">
              <div className="sx-latest-post-st-1">
                <div className="sx-post-media sx-img-effect img-reflection">
                  <NavLink to="/blogs/detail">
                    <ItodoImage src="images/blog/blog-grid/pic8.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="sx-post-info p-t30">
                  <div className="sx-post-meta ">
            ...
            <div className="masonry-item  col-lg-4 col-md-6 col-sm-12 m-b30">
              <div className="sx-latest-post-st-1">
                <div className="sx-post-media sx-img-effect img-reflection">
                  <NavLink to="/blogs/detail">
                    <ItodoImage src="images/blog/blog-grid/pic9.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="sx-post-info p-t30">
                  <div className="sx-post-meta ">
